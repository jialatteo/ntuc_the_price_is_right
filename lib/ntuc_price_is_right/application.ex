defmodule NtucPriceIsRight.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: NtucPriceIsRight.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    NtucPriceIsRightWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
